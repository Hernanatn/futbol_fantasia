...
//                                                                              //
// USAGE: On init call: GuiLoadStyleFf();                                   //
//                                                                              //
...
#define FF_STYLE_PROPS_COUNT  23

// Custom style name: ff
static const GuiStyleProp ffStyleProps[FF_STYLE_PROPS_COUNT] = {
    { 0, 0, 0x878787ff },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, 0x0d1f16ff },    // DEFAULT_BASE_COLOR_NORMAL 
    ...
    { 0, 19, 0x1b3e2cff },    // DEFAULT_BACKGROUND_COLOR 
...
#define FF_STYLE_FONT_ATLAS_COMP_SIZE 2126

// Font atlas image pixels data: DEFLATE compressed
static unsigned char ffFontData[FF_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle ffFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo ffFontGlyphs[189] = {
    { 32, 0, 13, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
...
// Style loading function: ff
static void GuiLoadStyleFf(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < FF_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(ffStyleProps[i].controlId, ffStyleProps[i].propertyId, ffStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int ffFontDataSize = 0;
    unsigned char *data = DecompressData(ffFontData, FF_STYLE_FONT_ATLAS_COMP_SIZE, &ffFontDataSize);
    ...
    memcpy(font.recs, ffFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, ffFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
